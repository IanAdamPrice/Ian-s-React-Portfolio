  ...
  return (
    <section class="hero" id="hero">
      ...
      <div class="aboutMe">
        ...
        <p>
            I am a graduate of the coding bootcamp at the University of North Carolina at Charlotte. I began my career as a filmmaker specializing in cinematography before making a transition into web development. 
            <br />
            <br />
